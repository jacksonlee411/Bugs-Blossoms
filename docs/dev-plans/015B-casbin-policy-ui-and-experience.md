...
**状态**: 进行中（2025-12-11 16:20，文档/翻译已补，等待 M3 长稳）
...
5. **[x] 文档与翻译**
   - [x] 更新 README/AGENTS：新增“从 UI 发起策略草稿”“PolicyInspector 使用方法”“授权反馈/重试/基线刷新”章节。
   - [x] `modules/*/presentation/locales/{en,ru,uz}.json` 增加 Unauthorized、PolicyInspector、SLA、按钮文案；提交前运行 `make check tr`。
   - [x] `docs/dev-records/DEV-PLAN-015-CASBIN-UI.md` 记录 UI 里程碑、命令、键盘巡检与授权差异。
