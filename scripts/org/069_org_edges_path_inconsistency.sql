-- DEV-PLAN-069 / C.1
-- Find org_edges slices whose parent edge path is not a prefix of the child edge path.
--
-- Usage:
--   PGPASSWORD=... psql "$DSN" -v ON_ERROR_STOP=1 \
--     -v tenant_id='00000000-0000-0000-0000-000000000001' \
--     -v hierarchy_type='OrgUnit' \
--     -f scripts/org/069_org_edges_path_inconsistency.sql
--
...
ORDER BY c.effective_date DESC, c.id ASC;
