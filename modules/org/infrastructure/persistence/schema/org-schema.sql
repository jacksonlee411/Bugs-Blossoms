...
CREATE INDEX org_outbox_pending_by_available ON org_outbox (available_at, sequence) WHERE published_at IS NULL;

CREATE INDEX org_outbox_published_by_time ON org_outbox (published_at, sequence) WHERE published_at IS NOT NULL;
