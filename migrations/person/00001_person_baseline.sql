...
CREATE INDEX IF NOT EXISTS persons_tenant_pernr_idx ON persons (tenant_id, pernr);
CREATE INDEX IF NOT EXISTS persons_tenant_display_name_idx ON persons (tenant_id, display_name);
